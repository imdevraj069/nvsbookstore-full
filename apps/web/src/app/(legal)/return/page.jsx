  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-700 leading-relaxed mb-6">
        ...
        <a href="mailto:info.nvsbookstore@gmail.com" className="text-blue-600 underline hover:text-blue-800">
          info.nvsbookstore@gmail.com
        </a>{" "}
        or via our{" "}
        <a href="/contact" className="text-blue-600 underline hover:text-blue-800">Contact Page</a>.
      </p>
