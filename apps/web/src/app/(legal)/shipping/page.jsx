export default function ShippingPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="mb-6">
        Please review our{" "}
        <a href="/return" className="text-blue-600 hover:underline">Return &amp; Refund Policy</a>{" "}
        for more details.
      </p>
      ...
      <ul className="list-disc ml-6 text-sm">
        ...
        <li>Online form: <a href="/contact" className="text-blue-600 hover:underline">Contact Us</a></li>
      </ul>
    </div>
  );
}
