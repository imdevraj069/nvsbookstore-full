  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
      ...
      <ul className="list-disc pl-6 space-y-2 mb-6">
        ...
        <li><strong>Company</strong>: (&quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;) refers to NVS Book Store.</li>
        <li><strong>Cookies</strong>: Small files that are placed on Your device by a website, containing browsing details among other uses.</li>
        ...
        <li><strong>Website</strong>: Refers to NVS Book Store</li>
      ...
      <p className="mb-4">
        ...
        include information such as Your IP address, browser type, pages
      ...
      <ul className="list-disc pl-6 space-y-2 mb-6">
        ...
        <li>To manage Your Account and purchases</li>
        <li>To contact You with updates and promotions</li>
        <li>To manage requests or support queries</li>
        <li>To analyze trends and improve the Service</li>
      ...
      <ul className="list-disc pl-6 space-y-1 mb-6">
        <li>Right to access, update or delete the information we have on You</li>
      ...
      <p className="mb-2">If you have any questions about this Privacy Policy:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li>Email: info.nvsbookstore@gmail.com</li>
        <li>Contact form: <a href="/contact" className="text-blue-600 underline">Contact Us</a></li>
      </ul>
    </div>
  );
}
