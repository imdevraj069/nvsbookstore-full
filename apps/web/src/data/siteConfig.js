export const siteConfig = {
  name: "NVS BookStore",
  tagline: "Your One-Stop Destination for Competitive Exam Books & Results",
  description:
    "NVS BookStore provides the latest exam results, admit cards, job notifications, and a curated collection of books for UPSC, SSC, Banking, Railways, and State PSC exams.",
};
